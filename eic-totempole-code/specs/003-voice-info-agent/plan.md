...
│           ├── useSpeechRecognition.ts         # Chrome SpeechRecognition wrapper (2026-09-10, new); `active` now press-gated and cleanup uses stop() not abort() (2026-09-23)
│           ├── useSpeechRecognition.test.ts
│           ├── markdown.tsx                    # Dependency-free markdown-to-React renderer for assistant replies (2026-09-23, new)
│           ├── markdown.test.tsx
│           ├── VoiceConversation.tsx           # Connects Direct Line + speech recognition; renders transcript (2026-09-10, replaces AgentEmbedContainer.tsx); push-to-talk button, thinking indicator, echo-dedup, markdown rendering added (2026-09-23)
